...
We stuck the original image on ..., and classified it using ResNet-50.
...
Since the authors have yet to release their code for success rate, we are unsure what caused this difference. We did use a different dataset than the authors, this could be a possible reason.\\

\subsubsection{Physical-World Attacks}
To verify that Diff-PGD can be applied to physical-world attacks, we tried an attack a laptop as our target object.
